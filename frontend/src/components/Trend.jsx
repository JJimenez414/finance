...
export default function Trend() {
  const { allTransactions, userCategories } = useBudgetContext();
  ...
  const categoryColor = (filterCategory ? categoryColorMap[filterCategory] : null) ?? DEFAULT_COLOR;
  ...
  return (
    <div className="flex flex-col px-4 pt-6 pb-28 overflow-y-auto" style={{ minHeight: "calc(100vh - 80px)" }}>
